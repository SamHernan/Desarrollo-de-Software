...
try{
    ...
    $statement = $conexion->query('SELECT C.Nombre,Pe.Id,Pe.Fecha,Pe.Status from Cliente C, Pedido Pe Where C.Id = Pe.Id_Cliente  and Pe.Status = "Listo" or C.Id = Pe.Id_Cliente  and Pe.Status = "Enviado" ORDER BY Pe.Fecha DESC');        
