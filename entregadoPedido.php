...
try{
    ...
    $statement = $conexion->query('SELECT  C.Nombre,Pe.Id,Pe.Fecha,Pe.Status,Pe.MethodPago,Pe.Total from Cliente C, Pedido Pe Where C.Id = Pe.Id_Cliente  and C.Id = Pe.Id_Cliente and Pe.Status = "Entregado" ORDER BY Pe.Fecha DESC');        
