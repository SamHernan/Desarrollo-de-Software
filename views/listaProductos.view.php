			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="/views/listaProductos.view.php">Productos Existentes</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
    ...
    <div class="main-container">
		<div class="pd-ltr-20">
			...
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="row">
					<div class="page-header">
						<a clas="active" href="/creacionProducto.php" class="btn btn-secondary btn-lg btn-block"  >Añadir Nuevo Producto al Almacen</a>
			...
			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
                    ...
                    <?php foreach ($link->query('SELECT * from producto') as $row){?> 
						<tr>
							<td class="table-plus">
							<img src="/img/img_productos/<?php echo $row['Imagen']; ?>" width="70" heigth="70"> 
							</td>
