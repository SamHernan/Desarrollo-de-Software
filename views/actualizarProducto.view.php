...
//conexion a bbdd
$link = mysqli_connect('localhost', 'root', '', 'bduv');
//si existe "id" en la url 
if(isset($_GET['Id'])){
	$id = $_GET['Id'];//le asigno una variable 
	$query1 = "SELECT * FROM producto WHERE id =".$id; //cadena de consulta para el elemento $id
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id = "nombre" name="nombre" value='<?= $nombre ?>' class="form-control form-control-user" onkeypress="return permite(event, 'car')">
										</div>
										<div class="form-group">
