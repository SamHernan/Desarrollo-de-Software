...
error_reporting(0);
if ($_SESSION['Pedido']['TotalPagar'] == 0) {
...
<body>
    ...
    <div id="about" class="about-main pad-top-100-producto pad-bottom-100">
        <div class="container">
            <h2 class="h2-2nice">Selecciona un método de Entrega</h2>
            <div class="row">
                    ...
                    <div id="owl-demo">
                        ...
                        <div class="item item-type-zoom entrega">
                            <form action="pago.php" method="post">
                                <input type="hidden" name="metodoEn" id="metodoEn" value="local">
                                <button class="item-hover" type="submit">
                                    <div class="item-info">
                                        <div class="headline">
                                            Recoge Pedido en Local
                                            <div class="line"></div>
                                            <div class="dit-line">Recoge tu pedido en nuestro local y ahórrate la comisión del envió.</div>
                                        </div>
                                    </div>
                                </button>
                            </form>
                            <div class="item-img">
                                <img src="images/local.png" alt="sp-menu">
                            </div>
                        </div>

                        <div class="item item-type-zoom entrega">
                            <form action="pago.php" method="post">
                                <input type="hidden" name="metodoEn" id="metodoEn" value="domicilio">
                                <button class="item-hover" type="submit">
                                    <div class="item-info">
                                        <div class="headline">
                                            Pedido a domicilio
                                            <div class="line"></div>
                                            <div class="dit-line">Te llevamos tu pedido hasta la puerta de tu casa, genera comisión extra.</div>
                                        </div>
                                    </div>
                                </button>
                            </form>
                            <div class="item-img">
                                <img src="images/delivery.png" alt="sp-menu">
                            </div>
                        </div>
